...
$gift_wrap = ($order['Order']['gift_wrap'] == 1) ? 'Oui' : 'Non';
...
{
	$html .='<div class="order-item"><div class="order-article-name"><span>' . $purchase['Purchase']['quantity'] . '</span> ' . $purchase['Product']['name'] . ' ' . $purchase['Article']['size'] . ' ' . $purchase['Article']['color'] . '</div><!--
...
$html .= '<div class="title order-total">Total de votre commande : <b>' . $order['Order']['price'] . '€ TTC</b></div>
		</div>
	</div>
</div>';
